...
export default function UserDetailModal({ user, type, onClose, onUpdate, onRemove, onToggleRetake }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-t-3xl sm:rounded-2xl shadow-2xl w-full sm:max-w-lg flex flex-col max-h-[92vh] overflow-hidden"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900">
          <div className="flex items-center gap-3">
            <Avatar name={user.name} photoUrl={user.photoUrl} className="w-10 h-10 rounded-xl text-sm shadow" />
            <div>
          ...
          {isStudent && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Location &amp; Preferences</p>
              </div>
